...
class _StudentExamScheduleScreenState extends State<StudentExamScheduleScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final schedules = _dataService.examSchedules.where((s) => 
    ...
    final ScheduleItem? imageItem = schedules.firstWhere(
      ...
      orElse: () => ScheduleItem(subject: '', day: '', date: '', time: '', location: '', department: '', level: '', imageUrl: '', isExam: true, id: ''),
    ).imageUrl.isNotEmpty
            ...
            child: GestureDetector(
              onTap: () {
                ...
                Navigator.push(context, MaterialPageRoute(
                  builder: (context) => ImageViewerScreen(imageUrl: img, title: 'صورة جدول الامتحانات'),
                ));
              },
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(LucideIcons.fileClock, size: 48, color: Colors.orange),
          ),
          const SizedBox(height: 24),
          Text(
            'جدول الامتحانات',
